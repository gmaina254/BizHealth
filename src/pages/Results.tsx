...
const Results = () => {
  ...
  const handleExport = () => {
    const lines = [
      "BizHealth AI — Financial Health Report",
      "======================================",
      "",
      `Health Score : ${analysis.healthScore}/100`,
      `Risk Level   : ${analysis.riskLevel}`,
      `Altman Z-Score: ${analysis.zScore.toFixed(2)}`,
      "",
      "--- Key Ratios ---",
      `Net Profit Margin : ${analysis.ratios.profitability.netMargin.toFixed(1)}%`,
      `Gross Margin      : ${analysis.ratios.profitability.grossMargin.toFixed(1)}%`,
      `Operating Margin  : ${analysis.ratios.profitability.operatingMargin.toFixed(1)}%`,
      `Current Ratio     : ${analysis.ratios.liquidity.currentRatio.toFixed(2)}x`,
      `Debt-to-Equity    : ${analysis.ratios.leverage.debtToEquity.toFixed(2)}x`,
      `Return on Assets  : ${analysis.ratios.efficiency.returnOnAssets.toFixed(1)}%`,
      `Return on Equity  : ${analysis.ratios.efficiency.returnOnEquity.toFixed(1)}%`,
      "",
      "--- Strengths ---",
      ...
      "--- Recommended Actions ---",
      "Immediate:",
      ...analysis.recommendations.immediate.map((r) => `  • ${r}`),
      "Quarterly:",
      ...analysis.recommendations.quarterly.map((r) => `  • ${r}`),
      "",
      `Generated by BizHealth AI on ${new Date().toLocaleDateString("en-KE", { dateStyle: "long" })}`,
    ];
    const blob = new Blob([lines.join("\n")], { type: "text/plain" });
    const url = URL.createObjectURL(blob);
    const a = document.createElement("a");
    a.href = url;
    a.download = "bizhealthai-report.txt";
    a.click();
    ...
    <div className="min-h-screen bg-gradient-hero">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <Button className="flex items-center gap-2 bg-gradient-primary" onClick={handleExport}>
